...
// import { listarServicosItens } from '../../services/fetchs';

// const ListarServicosItens = ({ navigation }) => {
//     const { data: servicos, isLoading, error } = useQuery({
//         queryKey: ['servicos'],
//         queryFn: listarServicosItens,
//     });
...
//                 <Text style={styles.itemPreco}>Preço mínimo: R$ {item.preco_min}</Text>
//             </View>
//         </TouchableOpacity>
//     );
...
// export default ListarServicosItens;